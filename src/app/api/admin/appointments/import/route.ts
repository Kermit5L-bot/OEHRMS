...
async function createCompletedAppointment(tx: Prisma.TransactionClient, data: ParsedImportRow) {
  ...
  const appointment = await tx.appointment.create({
    data: {
      ...
      internalContactInfo: data.internalContactInfo,
      customerLevel: data.customerLevel,
      mainVisitorInfo: data.mainVisitorInfo,
      customerType: data.customerType,
      interestAreas: data.interestAreas,
      needSolutionConsulting: data.needSolutionConsulting,
      ...
      needDining: data.needDining,
      diningRequirement: data.diningRequirement,
      giftPreparation: data.giftPreparation,
      giftRequirement: data.giftRequirement,
      receptionScheduleNote: data.receptionScheduleNote,
      receptionPreparationNote: data.receptionPreparationNote,
